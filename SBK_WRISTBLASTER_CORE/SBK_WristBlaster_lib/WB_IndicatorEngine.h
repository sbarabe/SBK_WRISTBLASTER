/*
 *  WB_IndicatorEngine.h is a part of SBK_WRISTBLASTER_CORE (Version 0) code for animations of a Wrist Blaster replica
...
#ifndef WB_INDICATORENGINE_H
#define WB_INDICATORENGINE_H
