/*
 *  WB_BarMeterEngine.h is a part of SBK_WRISTBLASTER_CORE (VERSION 0) code for bar meter animations of a Wrist Blaster replica
...
#ifndef WB_BARMETERENGINE_H
#define WB_BARMETERENGINE_H
