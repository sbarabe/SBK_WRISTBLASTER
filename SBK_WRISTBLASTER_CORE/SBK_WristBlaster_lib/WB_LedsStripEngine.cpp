/*
 *  WB_LedsStripEngine.cpp is a part of SBK_WRISTBLASTER_CORE (VERSION 0) code for bar meter animations of a Wrist Blaster replica
...
LedsStrip::LedsStrip(Adafruit_NeoPixel *strip) : _strip(strip), _updateRequired(true), _currentTime(0)
{
}
